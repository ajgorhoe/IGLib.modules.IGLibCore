...
namespace IG.Num
{
    ...
    /// <summary>Geometry and topology of an unstructured 1D mesh.
    ...
    /// $A Igor Jan08 Mar09;
    public class UnstructuredMeshGeometry1d<TCoord> : Field<TCoord>
    {


        /// <summary>Constructs a new empty unstructured grid (no elements contained) with no name and no description.</summary>
        public UnstructuredMeshGeometry1d()
            : this(0, null, null)
        { }

        /// <summary>Creates a new unstructured grid with the specified number of elements.</summary>
        /// <param name="numElements">Number of elements of the coordinates field.</param>
        public UnstructuredMeshGeometry1d(int numElements)
        ...
        public UnstructuredMeshGeometry1d(int numElements, string fieldName)
        ...
        public UnstructuredMeshGeometry1d(int numElements, string fieldName, string fieldDescription) :
