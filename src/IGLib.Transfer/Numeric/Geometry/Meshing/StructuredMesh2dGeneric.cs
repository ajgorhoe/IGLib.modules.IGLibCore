...
namespace IG.Num
{
    ...
    /// <summary>Generic 2D structured mesh with collections of named scalar, vector, tensor and index fields.
    ...
    /// $A Igor Jan08 Mar09;
    public class StructuredMesh2d<TCoord, TIndexField, TIndex, TScalarField, TScalar, TVectorField, TVector, TTensorField, TTensor> :
        StructuredMeshGeometry2d<TCoord>
        where TIndexField : StructuredField2d<TIndex>, new()
        where TScalarField : StructuredField2d<TScalar>, new()
        where TVectorField : StructuredField2d<TVector>, new()
        where TTensorField : StructuredField2d<TTensor>, new()
    {

        /// <summary>Constructs a new empty 2D field (no elements contained) with no name and no description.</summary>
        public StructuredMesh2d()
        ...
        public StructuredMesh2d(int dim1, int dim2)
        ...
        public StructuredMesh2d(int dim1, int dim2, string fieldName)
        ...
        public StructuredMesh2d(int dim1, int dim2, string fieldName, string fieldDescription) :
        ...
        private FieldCollection2d<TIndexField, TIndex> _indexFields;
        ...
        protected FieldCollection2d<TIndexField, TIndex> IndexFields
        {
            get
            {
                if (_indexFields == null)
                    _indexFields = new FieldCollection2d<TIndexField, TIndex>();
                return _indexFields;
            }
        }
        ...
        public TIndexField ActiveIndexField
        {
            get
            {
                if (_activeIndexField == null)
                {
                    ...
                    {
                        TIndexField @field = IndexFields.CreateField(Dim1, Dim2, IndexFields.DefauletFieldName,
                    ...
                    if (_activeIndexField == null)
                        throw new InvalidOperationException("Can not create and set active index field on the structured 2D mesh.");
                }
        ...
        /// <summary>Creates a new index field of dimensions that match dimensions of the current 2D structuredmesh, and specified 
        ...
        public void AddIndexField(TIndexField field)
        {
            if (field == null)
                throw new ArgumentNullException("field", "Field to be added is not specified (null argument).");
            if (field.Dim1 != this.Dim1 || field.Dim2 != this.Dim2)
            {
                if (field.Length == 0)
                    field.SetDimensions(this.Dim1, this.Dim2);
                else
                    throw new ArgumentException("Dimensions of the field to be added (" + field.Dim1 + ", " + field.Dim2 +
                        ") do not match dimension of the mesh (" + this.Dim1 + ", " + this.Dim2 + ").");
            }
        ...
        private FieldCollection2d<TScalarField, TScalar> _scalarFields;

        /// <summary>Gets the collection of scalar fields of the current mesh.
        /// <para>Created on first access (lazy evaluation).</para></summary>
        /// <remarks>Property is protected since the collection should not be accessed directly.</remarks>
        protected FieldCollection2d<TScalarField, TScalar> ScalarFields
        {
            get
            {
                if (_scalarFields == null)
                    _scalarFields = new FieldCollection2d<TScalarField, TScalar>();
        ...
        public TScalarField ActiveScalarField
        {
            get
            {
                if (_activeScalarField == null)
                {
                    ...
                    {
                        TScalarField @field = ScalarFields.CreateField(Dim1, Dim2, ScalarFields.DefauletFieldName,
                    ...
                    if (_activeScalarField == null)
                        throw new InvalidOperationException("Can not create and set active scalar field on the structured 2D mesh.");
                }
        ...
        /// <summary>Creates a new scalar field of dimensions that match dimensions of the current 2D structuredmesh, and specified 
        /// with name and description, and adds it to the current collection.</summary>
        /// <param name="fieldName">Name of the created field (normally it shouldn't be null though this is legal).</param>
        /// <param name="fieldDescription">Description of the created field (can be null).</param>
        /// <returns>The created field that is added to the collection.</returns>
        ...
        private FieldCollection2d<TVectorField, TVector> _vectorFields;

        /// <summary>Gets the collection of vector fields of the current mesh.
        /// <para>Created on first access (lazy evaluation).</para></summary>
        /// <remarks>Property is protected since the collection should not be accessed directly.</remarks>
        protected FieldCollection2d<TVectorField, TVector> VectorFields
        {
            get
            {
                if (_vectorFields == null)
                    _vectorFields = new FieldCollection2d<TVectorField, TVector>();
        ...
        public TVectorField ActiveVectorField
        {
            get
            {
                if (_activeVectorField == null)
                {
                    ...
                    {
                        TVectorField @field = VectorFields.CreateField(Dim1, Dim2, VectorFields.DefauletFieldName,
                    ...
                    if (_activeVectorField == null)
                        throw new InvalidOperationException("Can not create and set active vector field on the structured 2D mesh.");
                }
        ...
        /// <summary>Creates a new vector field of dimensions that match dimensions of the current 2D structuredmesh, and specified 
        /// with name and description, and adds it to the current collection.</summary>
        /// <param name="fieldName">Name of the created field (normally it shouldn't be null though this is legal).</param>
        /// <param name="fieldDescription">Description of the created field (can be null).</param>
        /// <returns>The created field that is added to the collection.</returns>
        ...
        private FieldCollection2d<TTensorField, TTensor> _tensorFields;

        /// <summary>Gets the collection of tensor fields of the current mesh.
        /// <para>Created on first access (lazy evaluation).</para></summary>
        /// <remarks>Property is protected since the collection should not be accessed directly.</remarks>
        protected FieldCollection2d<TTensorField, TTensor> TensorFields
        {
            get
            {
                if (_tensorFields == null)
                    _tensorFields = new FieldCollection2d<TTensorField, TTensor>();
        ...
        public TTensorField ActiveTensorField
        {
            get
            {
                if (_activeTensorField == null)
                {
                    ...
                    {
                        TTensorField @field = TensorFields.CreateField(Dim1, Dim2, TensorFields.DefauletFieldName,
                    ...
                    if (_activeTensorField == null)
                        throw new InvalidOperationException("Can not create and set active tensor field on the structured 2D mesh.");
                }
        ...
        /// <summary>Creates a new tensor field of dimensions that match dimensions of the current 2D structuredmesh, and specified 
        /// with name and description, and adds it to the current collection.</summary>
        /// <param name="fieldName">Name of the created field (normally it shouldn't be null though this is legal).</param>
        /// <param name="fieldDescription">Description of the created field (can be null).</param>
        /// <returns>The created field that is added to the collection.</returns>
