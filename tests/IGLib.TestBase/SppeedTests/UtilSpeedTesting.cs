...
namespace IGLib.Tests
{
    ...
    /// calculating a finite geometric series, which is used in tests like <see cref="StandardSpeedTestGeometricSeriesHpLaptop24(out SpeedTestInfo, bool)"/>.
    ...
    /// finite geometric series, <see cref="StandardSpeedTestGeometricSeriesHpLaptop24(bool)"/>., and property
    /// <see cref="ConstGeom.RefExecutionsPerSecondHpLaptop24"/> provides execution time on the machine whose
    ...
    /// Examples are <see cref="StandardSpeedTestGeometricSeriesHpLaptop24(out SpeedTestInfo, bool)"/>
    /// and <see cref="StandardSpeedTestGeometricSeriesHpLaptop24(bool)"/>.</para>
    ...
    public class UtilSpeedTesting
    {
        ...
        // Info about reference computers on which reference results were obtained:
...
ProcessorLink   ";
        ...
        public class ConstGeom : ConstGeomBase
        {
            ...
            public const double RefExecutionsPerSecondHpLaptop24 = 280e6;
        ...
        public class ConstGeomDirect : ConstGeomBase
        {
            ...
            public const double RefExecutionsPerSecondHpLaptop24 = 3e6;
        ...
        /// <param name="testInfo">Reference to a <see cref="SpeedTestInfo"/> object where test information is stored
        /// (parameters, IDs, reference result and machine on which it was produced, test duration, etc.).</param>
        ...
        public static double StandardSpeedTestGeometricSeriesHpLaptop24(out SpeedTestInfo testInfo, bool printToConsole = true)
        {
            int n = ConstGeom.NumExecutions;
            double a0 = ConstGeom.a0;
            double k = ConstGeom.k;
            double tolerance = ConstGeom.Tolerance;
            testInfo = new(ConstGeom.TestId, ConstMachineHpLaptop24.MachineId);
            testInfo.NumExecutions = n;
            testInfo.ReferenceExecutionsPerSecond = ConstGeom.RefExecutionsPerSecondHpLaptop24;
            if (printToConsole)
            {
            ...
            testInfo.ExecutionTimeSeconds = sw.Elapsed.TotalSeconds;
            if (printToConsole)
            {
            ...
            {
                Console.WriteLine("");
                Console.WriteLine($"Geometric series with {n} terms was calculated in {testInfo.ExecutionTimeSeconds} s.");
                Console.WriteLine($"  Calculations per second: {testInfo.NumExecutionsPerSecond}");
                Console.WriteLine($"  Millions  per second:    {testInfo.MegaExecutionsPerSecond}");
                Console.WriteLine($"  Speed factor:            {testInfo.SpeedFactor}");
            }
            return testInfo.NumExecutionsPerSecond;
        }

        /// <summary>Similar as <see cref="StandardSpeedTestGeometricSeriesHpLaptop24(out SpeedTestInfo, bool)"/>, which it
        ...
        public static double StandardSpeedTestGeometricSeriesHpLaptop24(bool printToConsole = true)
        {
            SpeedTestInfo testInfo;
            return StandardSpeedTestGeometricSeriesHpLaptop24(out testInfo, printToConsole);
        }
