...
namespace IGLib.Commands.Tests
{
    ...
    public class CommandRunnerUnsafeTests: CommandRunnerTestsBase<ExecutionInfoExtended, CommandRunnerExtendedUnsafe>
    {
        ...
        /// <param name=""></param>
        public CommandRunnerUnsafeTests(ITestOutputHelper output) :
