...
namespace IGLib.Types.Tests
{
    ...
    public class UtilTypesTests : TestBase<UtilTypesTests>
    {
        ...
        /// and the method that tells whether an object can be converted to int (<see cref="UtilTypes.IsConvertibleToInt(object, bool, IFormatProvider)"/>).
        ...
        /// <param name="testConversion">Tf true then the conversion method is tested (<see cref="UtilTypes.ToInt(object, bool, IFormatProvider)),
