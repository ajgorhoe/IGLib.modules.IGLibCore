...
using IGLib.Types.Single.Extensions;
...
namespace IGLib.Types.Single.Tests
{
    ...
    public class UtilTypesSingle_ExtensionMetodsTests : TestBase<UtilTypesSingle_ExtensionMetodsTests>
    {
        ...
        /// <param name=""></param>
        public UtilTypesSingle_ExtensionMetodsTests(ITestOutputHelper output) :
