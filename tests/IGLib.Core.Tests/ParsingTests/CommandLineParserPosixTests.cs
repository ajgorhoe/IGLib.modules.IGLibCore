...
namespace IGLib.Commands.Tests
{
    ...
    public class CommandLineParserPosixTests : CommandLineParserTests_Base<CommandLineParserPosixTests>
    {
        ...
        /// <param name=""></param>
        public CommandLineParserPosixTests(ITestOutputHelper output) :  base(output)  // calls base class's constructor
        {
            // Remark: the base constructor will assign output parameter to the Output and Console property.
        }


        protected override ICommandLineParser CommandLineParser { get; } = new CommandLineParserPosix();
